...
const BiometricScanner = ({ onScanComplete }) => {
    ...
    const [status, setStatus] = useState("Initializing Face Scan Link...");
    ...
    useEffect(() => {
        ...
        const steps = [
            ...
            { progress: 30, text: "Scanning Face Pattern..." },
            { progress: 60, text: "Verifying with Digilocker Database..." },
            { progress: 80, text: "Authenticating Identity..." },
            { progress: 100, text: "Face Scan Successful" }
        ];
    ...
    return (
        <div className="biometric-overlay">
            <div className="scanner-container glass-card">
                <h3 className="text-center text-white mb-3">Digilocker Face Scan</h3>
